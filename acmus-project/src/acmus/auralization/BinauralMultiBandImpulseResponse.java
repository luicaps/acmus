...
public class BinauralMultiBandImpulseResponse {
	...
	public BinauralMultiBandImpulseResponse(BandRangeSeq range, float[][] content,
			Vector[] direction) {
		this(range, content, direction, Float.MAX_VALUE);
	}

	public BinauralMultiBandImpulseResponse(BandRangeSeq range, float[][] content,
			Vector[] direction, float maxTime) {
		this(range, content, direction, (float) range.getSR(), maxTime);
	}

	public BinauralMultiBandImpulseResponse(BandRangeSeq range, float[][] content,
			Vector[] direction, float sampleRate, float maxTime) {
	...
	public static void main(String[] args) {
		...
		BinauralMultiBandImpulseResponse mbir = new BinauralMultiBandImpulseResponse(range,
				content, wave, maxTime);

...
public class AcmusGraphics {
  ...
  static {
    ...
    EDITOR_ACTION1_IMAGE_DISABLE = createImageDescriptor(prefix + "action1.gif").createImage(); //$NON-NLS-1$
    EDITOR_ACTION2_IMAGE_DISABLE = createImageDescriptor(prefix + "action2.gif").createImage(); //$NON-NLS-1$
    EDITOR_ACTION3_IMAGE_DISABLE = createImageDescriptor(prefix + "action3.gif").createImage(); //$NON-NLS-1$

    prefix = iconPath + "full/etool16/"; //$NON-NLS-1$
    EDITOR_ACTION1_IMAGE_ENABLE = createImageDescriptor(prefix + "action1.gif").createImage(); //$NON-NLS-1$
    EDITOR_ACTION2_IMAGE_ENABLE = createImageDescriptor(prefix + "action2.gif").createImage(); //$NON-NLS-1$
    EDITOR_ACTION3_IMAGE_ENABLE = createImageDescriptor(prefix + "action3.gif").createImage(); //$NON-NLS-1$

    prefix = iconPath + "full/wizban/"; //$NON-NLS-1$
    NEW_PROJECT_WIZARD_BANNER = createImageDescriptor(prefix + "newprj_wiz.png"); //$NON-NLS-1$

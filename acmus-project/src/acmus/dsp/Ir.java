...
public class Ir {
  ...
  public static final double[] dechirp(double[] rec, double[] ref, double[] B,
      double[] A, int n, IProgressMonitor monitor) {
  ...
  public static final double[] dechirp2(double[] rec, double[] ref, double[] B,
      double[] A, int n) {
    // function ir = dechirp(gravacao,B,A,n)
    //
    // ir = real(ifft(fft(gravacao(:,1),n)./fft(gravacao(:,2),n)));
  ...
  // determina-se o
  // // %% inicio da medicao a partir do mesmo. Caso o sinal seja mono, o inicio
  // da
  // // %% medicao e obtido a partir da propria resposta da sala.
  // // %% As variaveis de entrada, alem do sinal, sao os vetores de permutacao

...
//     testChu();
  ...
  public static void testChu() {
    try {
      ...
      BufferedReader br = new BufferedReader(new FileReader(
          "/home/lku/Workspace/acmus/data/ir3.mat"));
      PrintStream ps = new PrintStream(new FileOutputStream("/tmp/acmus.tmp.txt"));
      List l = new ArrayList();
      String line = br.readLine();
      while (line != null) {
        l.add(new Double(line.trim()));
  ...
  public static void testChu2() {    
    try {
      ...
      double []a = Util.normalize(Util.wavRead("/tmp/ir.wav"), (1 << 31) - 1);
      double []b = Util.normalize(Util.wavRead("/tmp/ir2.wav"), (1 << 31) - 1);
      System.out.println(" len " + a.length);
  ...
  public static void testFiltfilt() {
    double a[] = { 1, 2, 3, 4 };
    double b[] = { 5, 6, 7, 8 };
    // double x[] = { 5, 6, 7, 8, 5, 6, 7, 8, 5, 6, 7, 8 , 9 , 9, 9 ,9, 9 , 9, 9
    // ,9, 9 , 9, 9 ,9};
  ...
  public static void testDechirp() {
    ...
    // 0.0059901, 0.043819, -0.045384, -0.05117, 0.10738, 0.042063, -0.16144,
    ...
    double b[] = { 6.8958198127898718e-02, 0.0000000000000000e+00,
        ...
        -2.7583279251159487e-01, 0.0000000000000000e+00, 6.8958198127898718e-02 };
    double a[] = { 1.0000000000000000e+00, -4.3613393544232331e+00,
        ...
        9.6339964091306085e-01, -1.5978865589624947e-01, 2.0292549971106792e-02 };
    // double ir[] = {8.7795294836709159e-01, -2.1619707439127157e-02,
    // 2.7757686718965925e-02, 2.3528124996866642e-02,-4.8674336678340813e-02,
    // 5.9900905029896525e-03,4.3818659747500370e-02, -4.5384208584541542e-02,
    // -5.1169816398999091e-02, 1.0738264068538364e-01, 4.2063183738654059e-02,
    // -1.6144387813396605e-01, 1.0650658932563289e-01, -1.4829946826169206e-02,
    // 1.7450851794950087e-03, 1.0637688479856403e-01};
  
    // double b[] = { 0.0690, 0, -0.2758, 0, 0.4137, 0, -0.2758, 0, 0.0690 };
    // double a[] = { 1.0000, -4.3613, 7.9766, -8.3677, 5.9555, -3.0270, 0.9634,
    // -0.1598, 0.0203 };
...
//    }
  ...
  public static void testFft3() {
    ...
    System.out.println("done: " + (System.currentTimeMillis() - t));
    for (int i = 0; i < 10; i++) {
      System.out.println(x[i] + " " + y[i] + "i  |  " + x2[i] + " " + y2[i]
          + "i");
    }
...
//      }
  ...
  public static void testConv() {
    try {
      ...
      {
      AudioInputStream ais = AudioSystem.getAudioInputStream(new File("/home/lku/Workspace/acmus/data/tone1.wav"));
      int a[] = AudioPlayer.readData(ais);
      ais = AudioSystem.getAudioInputStream(new File("/home/lku/Workspace/acmus/data/ir3.wav"));
  ...
  public static void testWavAverage() {
    ...
    Util.wavAverage("/tmp/avg.wav", 32, "/tmp/1.wav", "/tmp/2.wav","/tmp/3.wav","/tmp/4.wav");

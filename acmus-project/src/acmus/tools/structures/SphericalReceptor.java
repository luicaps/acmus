...
//
//public final class SphericalReceptor implements Receptor{
...
//
//	public SphericalReceptor(Vector center, float radius, float soundSpeed, float airAbsortionCoefficient) {
//		this.center = center;
//		this.radius = radius;

...
public class ProjectPropertiesControl extends Composite {
  ...
  public void loadProperties(InputStream is) {
    ...
    fIrLength.setText(fProperties.getProperty("IrLength", ""+Util.DEFAULT_IR_LENGTH));
    fRecExtra.setText(fProperties.getProperty("RecordingExtraTime", ""+Util.DEFAULT_REC_EXTRA));
  }

...
public class AcmusMeasurementSetWizardFirstPage extends WizardPage {
  ...
  public AcmusMeasurementSetWizardFirstPage(String name, String projectName, String sessionName, String posFile) {
    super(name);
  ...
  public void createControl(Composite parent) {
    ...
    _propertiesControl = new SetPropertiesControl(composite, SWT.NONE,_posFile);
